...
import HandleCheckPhoneForgotPassword from "./step1"
import HandleCheckOtpForgotPassword from "./step2"

export default function CheckOtpForgotPassword({...props}){
    ...
    return(
        <>
            ...
            {props.step === 1 &&
                <HandleCheckPhoneForgotPassword
                    title={props.title1}
